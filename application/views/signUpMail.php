    ...
    <div style="max-width: 600px;margin: 0 auto;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" class="email-container">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-table-lspace: 0pt !important;mso-table-rspace: 0pt !important;border-spacing: 0 !important;border-collapse: collapse !important;table-layout: fixed !important;">
          ...
          <td class="bg_white logo" style="padding: 1em 2.5em;text-align: center;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background: #ffffff;mso-table-lspace: 0pt !important;mso-table-rspace: 0pt !important;">
			<img src="<?= BASE_URL; ?>images/logo.png" height="70px" style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;-ms-interpolation-mode: bicubic;">
            <h1 style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: 'Playfair Display', serif;color: #000000;margin-top: 0;margin: 0;"><a href="#" style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;text-decoration: none;color: #000;font-size: 20px;font-weight: 700;text-transform: uppercase;font-family: 'Montserrat', sans-serif;">Knifemaster Gaming</a></h1>
          </td>
	      </tr><!-- end tr -->
				<tr style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
          <td valign="middle" class="hero" style="background-image: url(<?= BASE_URL; ?>images/PUBG.jpg);background-size: cover;height: 400px;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;position: relative;mso-table-lspace: 0pt !important;mso-table-rspace: 0pt !important;">
		          ...
		          <tr style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
		            <td class="bg_dark email-section" style="text-align: center;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background: rgba(0,0,0,.8);padding: 2.5em;mso-table-lspace: 0pt !important;mso-table-rspace: 0pt !important;">
		            	<div class="heading-section heading-section-white" style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: rgba(255,255,255,.8);">
		              	...
		              	<h2 style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: line-height: 1;color: #ffffff;margin-top: 0;font-size: 28px;line-height: 1.4;padding-bottom: 0;">Welcome To Knifemaster Gaming</h2>
		              	<p style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">Thanks <b style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;"><?= $name ?></b> for joining us. <br style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">Knifemaster gaming welcome you in the word of indian esports. We wish you Good luck for you future in Indian eSports  & Dont forget to follow us on <a href="https://www.instagram.com/knife_master_gaming/" target="_blank" style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;text-decoration: none;color: #f3a333;">Instagram</a> and <a href="https://twitter.com/KnifemasterG" target="_blank" style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;text-decoration: none;color: #f3a333;">Twitter</a></p>
		              	<p style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">And please subscribe to our<a href="https://www.youtube.com/channel/UCNRW3JjfEmGW0W9_R1WnElQ" target="_blank" style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;text-decoration: none;color: #f3a333;"> Youtube </a>Channel!</p>
		            	</div>
		            </td>
		          </tr><!-- end: tr -->
